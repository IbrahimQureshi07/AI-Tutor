    ...
    <main className="container py-12 md:py-16 max-w-4xl">
      <div className="text-center max-w-2xl mx-auto mb-10">
        <Badge variant="outline" className="mb-4 border-primary/30">
          ...
          {BRAND.shortName} · No signup required
        </Badge>
        ...
        <p className="mt-4 text-ink-muted text-lg leading-relaxed">
          Sample real SC exam-style questions with a taste of the{" "}
          {BRAND.shortName} {BRAND.productName}. One preview per device — then
